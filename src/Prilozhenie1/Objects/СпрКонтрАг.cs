    ...
    public class СпрКонтрАг : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СпрКонтрАгE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СпрКонтрАгE", typeof(IIS.Prilozhenie1.СпрКонтрАг));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СпрКонтрАгL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СпрКонтрАгL", typeof(IIS.Prilozhenie1.СпрКонтрАг));
                }
            }
        }
    }
